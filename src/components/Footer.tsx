      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-4 text-zinc-600">
            <a href="https://x.com/enhanced1g1tal" target="_blank" className="p-2 border border-transparent rounded-md hover:border-neon-cyan hover:shadow-[0_0_15px_rgba(0,255,255,0.4)] hover:text-neon-cyan transition-all duration-300">
              <Twitter className="w-5 h-5" />
            </a>
            <a href="https://www.linkedin.com/company/enhance-digital-llc/about/" target="_blank" className="p-2 border border-transparent rounded-md hover:border-neon-cyan hover:shadow-[0_0_15px_rgba(0,255,255,0.4)] hover:text-neon-cyan transition-all duration-300">
