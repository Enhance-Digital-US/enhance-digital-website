        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch relative">
          <div className="relative w-full border border-neon-cyan/30 bg-black p-1 shadow-[0_0_30px_rgba(0,255,255,0.05)] flex flex-col h-full">
            ...
            <div className="flex-1 p-6 relative overflow-hidden flex flex-col gap-5 bg-[#0a0a0a]">
              ...
              >
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-2xl rounded-tl-sm p-4 text-sm text-zinc-300">
                  Perfect. We can deploy a <span className="text-neon-cyan font-mono">Creative Asset</span> automation workflow and synchronize your marketing channels. This typically yields a <span className="text-white font-bold">1.25x ROI</span>.
              ...
              >
                ...
                <div className="bg-neon-cyan/10 border border-neon-cyan/30 rounded-2xl rounded-tr-sm p-4 text-sm text-white">
                  Can we also use GenAI for our affiliate marketing strategy to improve lead quality?
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-2xl rounded-tl-sm p-4 text-sm text-zinc-300">
                  Absolutely. We can deploy AI agents to generate targeted affiliate content and qualify inbound leads automatically, improving conversion rates significantly.
                </div>
              </motion.div>
            </div>
          ...
          <motion.div style={{ y: y2 }} className="max-w-xl pb-32">
            ...
            <div className="space-y-6 text-base md:text-lg text-zinc-400 leading-relaxed font-mono">
              ...
              <p>
                We combine data-driven marketing, modern creative design, and smart automation to deliver results that actually move the needle.
              </p>
              <p>
                Our team consists of experienced professionals who are passionate about helping small businesses succeed in the digital landscape.
              </p>
            </div>

            <div className="mt-12 grid grid-cols-2 gap-8 pt-12 border-t border-zinc-800">
              <div>
                <h4 className="text-4xl font-display font-bold mb-2 text-neon-cyan">100+</h4>
                <p className="text-xs font-mono text-zinc-500 uppercase tracking-wider">Workflows_Automated</p>
              </div>
              <div>
                <h4 className="text-4xl font-display font-bold mb-2 text-white">1.5x</h4>
